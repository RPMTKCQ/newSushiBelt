...
//        Gdx.app.log("RECIPE_UI", "added order: " + dishName + " at " + x + "," + START_Y);
//        cards.add(new RecipeCard(dishName, customerId, x, START_Y));
//    }
//
...
//        Gdx.app.log("RECIPE_UI", "drawing " + cards.size() + " cards, first at: " +
//            (cards.isEmpty() ? "none" : cards.get(0).x + "," + cards.get(0).y));
//        uiViewport.apply();
